        ...
        <div>
            ...
            <div className=' d-flex head23' id='ttp'>
                ...
                <div className='d-flex head2 mt-1'>
                    ...
                    <p className='head4 mt-1' data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Bag(0)</p>
                </div>
            </div>
                ...
                <nav className="navbar navbar-expand-lg navbar-light main50">
                    <div className="">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div className="d-flex mod1" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                <p className=' mod'>SEARCH</p>
                                <CiSearch className='mod2' />
