        ...
        <div>
            <div className='container'>
                ...
                <div className='col-lg-3 '>
                    <div className='men1 mt-5'>
                    <img src='https://shella-demo5.myshopify.com/cdn/shop/files/08_297x.progressive.png.jpg?v=1614334854' alt='' className='men2'/>
                    </div>
                   
                       <p className='men3 text-center mt-2 text-black'>NEWIN</p>
                       <div className='men4 text-center text-secondary'>Spring/Summer 2020 Collection</div>
                </div>
                ...
                <div className='shop3 text-white text-center mt-2'>SALE</div>
                </p> 
                <div>
                ...
                <div className='col-lg-2 '>
                <p className='shop1 mt-5 text-black'>ACCESSORIES</p>
                <div>
                    <img src='	https://shella-demo5.myshopify.com/cdn/shop/files/11_170x.progressive.png.jpg?v=1614334854' alt='' className=''/>
                </div>
              
                 <div className='text-secondary shop2 mt-1'>Backpacks</div>
                 <div className='text-secondary shop2 mt-1'>Hats</div>
                 <div className='text-secondary shop2 mt-1'>Belts</div>
                 <div className='text-secondary shop2 mt-1'>Glasses</div>
                 <div className='text-secondary shop2 mt-1'>Mobile Accessories</div>
                 <div className='text-secondary shop2 mt-1'>Socks</div>
                </div>


                <div className='col-lg-3 '>
                    <div className='men5 mt-5'>
                    <img src='https://shella-demo5.myshopify.com/cdn/shop/files/07_297x.progressive.png.jpg?v=1614334854' alt='' className='men2'/>
                    </div>
                    <p className='men3 text-center mt-2 text-black'>NEWIN</p>
                       <div className='men4 text-center text-secondary'>Spring/Summer 2020 Collection</div>
