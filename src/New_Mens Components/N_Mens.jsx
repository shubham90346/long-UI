...
import N_Home from './N_Home';
import N_Home2 from './N_Home2';
...
function N_Mens(props) {
    ...
    return (
        <div>
            ...
            <div className='' >
                <p className='gallery text-center text-white ' id='ref'>FINAL CLEARANCE: Take 20% off 'Sale Must-Haves' </p>
            </div>
       ...
       <hr className='mt-5'></hr>
            ...
            <div className='top11'>
                <a className='tp1 text-white d-flex justify-content-center mt-1' href='#ref'><BsArrowUp className='mt-2 foo12' /></a>
            </div>
